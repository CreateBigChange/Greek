...
CREATE TABLE `admin_user_roles` (
  ...
  CONSTRAINT `admin_user_roles_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `admin_roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `admin_user_roles` VALUES (1,1),(7,1),(14,1),(16,1),(17,1),(7,6),(22,6),(23,13),(24,13);
