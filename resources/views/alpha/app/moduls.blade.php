...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog" style="width: 80%;">
		<div class="modal-content">
			<form class="form-horizontal tasi-form" method="post" action='/alpha/app/version/add'>
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					...
					<section class="panel" style="margin-bottom:0px">
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name='version' placeholder="V1.0.1"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 col-sm-2 control-label">系统</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name='type' placeholder="andriod | ios"/>
								</div>
							</div>

							<div class="form-group">
                               <label class="col-sm-2 col-sm-2 control-label">包文件</label>
                                <div class="col-sm-10">
                                    <div class="file" style="margin-left:15px;">
                                        选择文件
                                        <input type="text" class="form-control" name='download_file' id="download_file" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                               <label class="col-sm-2 col-sm-2 control-label">下载链接</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='download' id="download" value=""/>
                                </div>
                            </div>
						</div>
					</section>
...
$('.add').bind('click' , function(){
	...
	var img = new Dropzone("#download_file", {
		url: "/upload/qiniu/apk",
		addRemoveLinks: true,
		maxFiles: 1,
		paramName:'img',
		maxFilesize: 5120,
	...
	console.log(data);
		if(data.code == '0000'){
			$('#download_file').val(data.data.host + '/' + data.data.key);
			$('#download').attr('src' , data.data.host + '/' + data.data.key);
		}
	});
